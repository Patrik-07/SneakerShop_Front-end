...
export const CustomItem = () => {
  return (
    <div className="top-32 left-0 w-full h-[350px] relative flex items-center drop-shadow-md px-14">
      <div
        ...
        <div className="flex flex-row h-full w-full">
          <div className={`rounded-l-[18px] w-full h-full flex`}>
            <div className="absolute top-0 left-0 bg-[#0077FF] h-10 w-32 rounded-br-[20px] rounded-tl-[18px] flex items-center">
              <span className="text-white text-[16px] font-bold absolute left-4">
                BRAND NEW
              </span>
            </div>
            <img
            ...
            <div>
              <button
                onClick={() => {}}
                className="absolute bottom-6 left-[220px] flex items-center justify-center h-8 w-8 rounded-full overflow-hidden bg-white ml-2"
              >
                <Icon className={"w-1/2 h-1/2"} iconDefinition={faArrowRight} />
              </button>
              <button
                onClick={() => {}}
                className="absolute bottom-6 left-[190px] flex items-center justify-center h-8 w-8 rounded-full overflow-hidden bg-white"
              >
          ...
          <div className="absolute left-[340px] top-[30px] w-full h-full">
            <div className="text-white font-bold text-5xl">
              <span>NIKE ZOOM </span>
              <span className="text-blue-500 italic drop-shadow-xl">
                FREAK{" "}
              </span>
              <span>4</span>
            </div>
            <div className="text-white text-xl w-1/2 pt-10">
              <span>
                With a liquid-like fit, Zoom Air and a design that moves with
                you, this special{" "}
              </span>
              <span className="text-blue-500 italic font-bold drop-shadow-xl">
                Freak 4 ASW{" "}
              </span>
              <span>
